...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        self.p1 = Pessoa('Diego', 'Farias')
        self.p2 = Pessoa('Angela', 'Maria')

    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Diego')
        self.assertEqual(self.p2.nome, 'Angela')
    ...
    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Farias')
...
#   python -m unittest -v EXECUTA TODOS OS TESTES DA PASTA
